...
class Detector:
    def __init__(self, ckpt, use_gpu=False):
        ...
        #Load model
        self.mode_directory = "C:/Users/jared/OneDrive/Documents/GitHub/ECE4078-Thursday-12-3-G6/Milestone3/network/scripts/Model/best.pt"# weight directory path
        self.yolo_model = torch.hub.load('ultralytics/yolov5', 'custom', path=self.mode_directory)
        self.yolo_model.conf = 0.6 # confidence level
